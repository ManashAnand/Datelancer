...
const Profile = () => {
  ...
  <div className="md:flex no-wrap md:-mx-2 ">
    ...
    <div className="w-full md:w-9/12 mx-2 h-64  flex flex-col mb-[40rem] -translate-x-3 md:mb-0 md:-translate-x-0">
      <div className="bg-white p-3 shadow-sm rounded-sm mt-4 sm:mt-0 ">
        ...
        <div className="text-gray-700">
          <div className="grid md:grid-cols-2 text-sm">
            <div className="grid grid-cols-2">
              ...
              <div className="px-4 py-2">{state?.userDoc?.name}</div>
            </div>
            <div className="grid grid-cols-2">
            ...
            <div className="grid grid-cols-2">
              ...
              <div className="px-4 py-2">
                <a className="text-blue-800" href="mailto:jane@example.com">{state?.userDoc?.email}</a>
              </div>
            </div>
            <div className="grid grid-cols-2   ">
