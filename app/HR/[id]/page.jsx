  ...
  return (
    <>
      ...
      <div className="bg-[#F2EFE8] dark:bg-[#020817] dark:text-black">
        ...
        <div className=" flex justify-between items-center flex-col-reverse sm:flex-row m-5 p-5 border rounded-md bg-white">
          <div className="min-w-[50%] ">
            ...
            <button
              ...
              type="button"
              className="mt-6 text-white bg-yellow-700 hover:bg-yellow-800 focus:ring-4 focus:outline-none focus:ring-yellow-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:bg-yellow-600 dark:hover:bg-yellow-700 dark:focus:ring-yellow-800"
            >
              Complete profile
              <svg
                className="rtl:rotate-180 w-3.5 h-3.5 ms-2"
            ...
            <button
              onClick={() => router.push(`/HR/addProject/${id}`)}
              type="button"
              className="mt-6 ml-4 text-white bg-yellow-700 hover:bg-yellow-800 focus:ring-4 focus:outline-none focus:ring-yellow-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:bg-yellow-600 dark:hover:bg-yellow-700 dark:focus:ring-yellow-800"
            >
              Add Project
              <svg
                className="rtl:rotate-180 w-3.5 h-3.5 ms-2"
        ...
        <div className="m-5 text-2xl font-semibold dark:text-white">
          Open Projects
        </div>

        <div className=" flex gap-8 items-center flex-col-reverse sm:flex-row m-5 p-5 border rounded-md bg-white">
          <div className="flex gap-4">
            Select Project <Separator orientation="vertical" /> India Business
            Head
          </div>
        </div>
